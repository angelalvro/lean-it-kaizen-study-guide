...
- Teoría organizada en los **8 módulos** del temario: Introducción a Kaizen, Organizando Kaizen, Método A3, y las 5 fases del ciclo **DMAIC** (Fase Definición, Fase Medición, Fase Análisis, Fase Mejora, Fase Control) — con la terminología en **español auditada contra el examen oficial**: Mapa de Cadena de Valor (no "Value Stream Map"), Plazo de entrega (Lead Time), Eficiencia del proceso (PCE), AMFE (FMEA), Voto Múltiple, Corredores/Repetidores/Fondistas, Voz del Cliente/Negocio/Proceso/Regulador, patrocinador/líder kaizen, partes interesadas, Seguimiento (no "Monitorización"), panel de mejoras, lista de control (checklist), cuadro de mando (dashboard), Estado actual y Objetivos del estado futuro (secciones del A3), entre otros.
...
- Cinco **simulacros adicionales**: dos de 20 preguntas (Fácil / Medio), uno de 40 ("Repaso completo"), uno de 32 ("Casos difíciles") y uno de 22 ("Puntos calientes", centrado en los temas que más se repiten en el feedback de examinados reales: habilidades del A3, cuándo ir al Gemba, herramientas para priorizar, causa común vs. especial, Cynefin con opciones muy parecidas...) — 174 preguntas de práctica en total, todas con corrección, explicación y desglose de aciertos por módulo.
...
| Preguntas | 40 |
| Duración | 90 minutos |
| Nota de corte | ≥ 26/40 (65%) |
| Prerrequisito | Lean IT Foundation |
| Idiomas disponibles | Inglés, español, japonés |
...
3. **Análisis propio del examen de muestra oficial** publicado por APMG (Sample Paper de 40 preguntas): se resolvió íntegramente para verificar la cobertura de la guía y detectar huecos — de ahí salen, por ejemplo, la terminología oficial en español (Corredores/Repetidores/Fondistas), el ejemplo numérico de cálculo de Lead Time/Takt/PCE, o la trampa "réplica vs. estandarización". **No se reproduce ninguna pregunta de ese examen de muestra** (ni su redacción ni sus escenarios) en esta guía — solo los conceptos que evalúa, convertidos en contenido y preguntas propias.
4. **Feedback real de personas que ya se examinaron** (recopilado en un foro/grupo del curso): recuerdos y resúmenes en sus propias palabras sobre qué tipo de preguntas les salieron — no transcripciones del examen. De ahí sale, por ejemplo, el simulacro "Casos difíciles", la distinción Incidente/Problem(ITIL)/"problema" genérico, los ejercicios de cálculo de PCE con varios pasos, o el contraste causa común vs. especial con dos procesos.
5. **Auditoría de terminología en español**: como el examen se presenta en español, se revisó toda la teoría comparando cada término contra la redacción exacta usada en las 40 preguntas del examen de muestra oficial y en el feedback real (p. ej. "Mapa de Cadena de Valor" en vez de "Value Stream Map", "Plazo de entrega" en vez de "Lead Time", "AMFE" en vez de "FMEA", "Seguimiento" en vez de "Monitorización", "partes interesadas" en vez de "stakeholders"), corrigiendo mezclas de inglés/español que había en versiones anteriores de la guía.
